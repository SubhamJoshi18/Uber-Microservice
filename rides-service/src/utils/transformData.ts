...
export const isMatchLength =  (str1:string,str2:string) => {
    return str1.length.toString().startsWith(str2.length.toString())
}

export const isMatchString = (str1:string,str2:string) => {
    return str1 === str2
}