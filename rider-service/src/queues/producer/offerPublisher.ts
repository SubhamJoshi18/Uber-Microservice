...
export const publishOfferToUser  = async (channel : Channel,queueConfig : IQueueConfig,content:any) : Promise<void|boolean> => {
    ...
    try{    
        ...
        uberLogger.info(`The Message has been Sended to the User Successfully`)
    }catch(err){
